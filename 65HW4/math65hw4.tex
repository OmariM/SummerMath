...
Theorem 6.26 for the vector $\VEC{v}$ by computing $T(\VEC{v})$ directly and using the theorem.\\
...
$[T]_{\mathcal{C}}$ of $T$ with respect to $C$ is diagonal.
\[
	T: \mathcal{P}_2 \rightarrow \mathcal{P}_2 \text{ defined by } T(p(x)) = p(x+1).
\]
\end{problem}
